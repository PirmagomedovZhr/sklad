...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Good.collection'
        db.delete_column('shop_good', 'collection_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table('shop_collection', (
            ...
            ('good', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='is_collection', null=True, to=orm['shop.Good'], blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ))
        db.send_create_signal('shop', ['Collection'])

        # Adding field 'Good.collection'
        db.add_column('shop_good', 'collection', self.gf('django.db.models.fields.related.ForeignKey')(related_name='goods', null=True, to=orm['shop.Collection'], blank=True), keep_default=False)
