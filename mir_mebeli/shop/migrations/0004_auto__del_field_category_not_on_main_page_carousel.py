...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Category.not_on_main_page_carousel'
        db.delete_column('shop_category', 'not_on_main_page_carousel')


    def backwards(self, orm):
        
        # Adding field 'Category.not_on_main_page_carousel'
        db.add_column('shop_category', 'not_on_main_page_carousel', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
