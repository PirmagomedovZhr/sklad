...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Good.short_description'
        db.add_column('shop_good', 'short_description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Good.short_description'
        db.delete_column('shop_good', 'short_description')
