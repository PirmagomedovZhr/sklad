...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OrderNoReg'
        db.create_table('shop_ordernoreg', (
        ...
        db.send_create_signal('shop', ['OrderNoReg'])

        # Adding model 'OrderNoRegItem'
        db.create_table('shop_ordernoregitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['shop.OrderNoReg'])),
        ...
        db.send_create_signal('shop', ['OrderNoRegItem'])


    def backwards(self, orm):
        
        # Deleting model 'OrderNoReg'
        db.delete_table('shop_ordernoreg')

        # Deleting model 'OrderNoRegItem'
        db.delete_table('shop_ordernoregitem')
    ...
    models = {
        ...
        'shop.category': {
            ...
            'order': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '20', 'null': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'shop.good': {
            ...
            'amount': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20', 'blank': 'True'}),
        ...
        'shop.ordernoregitem': {
            'Meta': {'object_name': 'OrderNoRegItem'},
            'count': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'good': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Good']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': "orm['shop.OrderNoReg']"}),
            'price': ('django.db.models.fields.DecimalField', [], {'max_digits': '7', 'decimal_places': '0'})
        },
        'shop.orderpayment': {
