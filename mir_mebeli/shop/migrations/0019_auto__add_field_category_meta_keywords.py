...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_category', 'meta_keywords', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.meta_keywords'
        db.delete_column('shop_category', 'meta_keywords')
    ...
    models = {
        ...
        'shop.category': {
            ...
            'meta_keywords': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
