...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Good.category'
        db.add_column('shop_good', 'category', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='goods2', null=True, to=orm['shop.Category']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Good.category'
        db.delete_column('shop_good', 'category_id')
    ...
    models = {
        ...
        'shop.good': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'goods2'", 'null': 'True', 'to': "orm['shop.Category']"}),
