...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Good.units'
        db.add_column('shop_good', 'units', self.gf('django.db.models.fields.CharField')(default=u'', max_length=20, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Good.units'
        db.delete_column('shop_good', 'units')
    ...
    models = {
        ...
        'shop.good': {
            ...
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'units': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '20', 'blank': 'True'}),
