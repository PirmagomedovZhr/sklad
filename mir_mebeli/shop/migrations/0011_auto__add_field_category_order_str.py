...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_category', 'order_str', self.gf('django.db.models.fields.CharField')(default='', max_length=20, db_index=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'shop.category': {
            ...
            'order_str': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20', 'db_index': 'True', 'blank': 'True'}),
