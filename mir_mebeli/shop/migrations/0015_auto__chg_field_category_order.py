...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('shop_category', 'order', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Category.order'
        db.alter_column('shop_category', 'order', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True))
