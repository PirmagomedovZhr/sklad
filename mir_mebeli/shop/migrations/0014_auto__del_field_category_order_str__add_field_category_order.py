...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Category.order_str'
        db.delete_column('shop_category', 'order_str')

        # Adding field 'Category.order'
        db.add_column('shop_category', 'order', self.gf('django.db.models.fields.CharField')(default='', max_length=20, db_index=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Category.order_str'
        db.add_column('shop_category', 'order_str', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True, db_index=True), keep_default=False)

        # Deleting field 'Category.order'
        db.delete_column('shop_category', 'order')
    ...
    models = {
        ...
        'shop.category': {
            ...
            'order': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20', 'db_index': 'True', 'blank': 'True'}),
