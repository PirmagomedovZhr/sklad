...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cart_cart', 'delivery_id')

        # Adding field 'Cart.city'
        db.add_column('cart_cart', 'city', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['shop.City'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Cart.delivery'
        db.add_column('cart_cart', 'delivery', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['shop.Delivery'], null=True, blank=True), keep_default=False)

        # Deleting field 'Cart.city'
        db.delete_column('cart_cart', 'city_id')
