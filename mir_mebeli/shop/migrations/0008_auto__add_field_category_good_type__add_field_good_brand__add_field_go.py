...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Category.good_type'
        db.add_column('shop_category', 'good_type', self.gf('django.db.models.fields.CharField')(default='', max_length=50, db_index=True, blank=True), keep_default=False)

        # Adding field 'Good.brand'
        db.add_column('shop_good', 'brand', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Good.weight'
        db.add_column('shop_good', 'weight', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)

        # Adding field 'Good.color'
        db.add_column('shop_good', 'color', self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True), keep_default=False)

        # Adding field 'Good.usage_area'
        db.add_column('shop_good', 'usage_area', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Good.expense'
        db.add_column('shop_good', 'expense', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Changing field 'Good.producer'
        db.alter_column('shop_good', 'producer', self.gf('django.db.models.fields.CharField')(max_length=80, blank=True))

        # Changing field 'Good.dims'
        db.alter_column('shop_good', 'dims', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'Category.good_type'
        db.delete_column('shop_category', 'good_type')

        # Deleting field 'Good.brand'
        db.delete_column('shop_good', 'brand')

        # Deleting field 'Good.weight'
        db.delete_column('shop_good', 'weight')

        # Deleting field 'Good.color'
        db.delete_column('shop_good', 'color')

        # Deleting field 'Good.usage_area'
        db.delete_column('shop_good', 'usage_area')

        # Deleting field 'Good.expense'
        db.delete_column('shop_good', 'expense')

        # Changing field 'Good.producer'
        db.alter_column('shop_good', 'producer', self.gf('django.db.models.fields.CharField')(max_length=80, null=True, blank=True))

        # Changing field 'Good.dims'
        db.alter_column('shop_good', 'dims', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True))
    ...
    models = {
        ...
        'shop.good': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'dims': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
